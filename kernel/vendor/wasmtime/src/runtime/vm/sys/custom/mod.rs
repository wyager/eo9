...
#[inline]
pub fn concurrent_tls_get() -> *mut u8 {
    unsafe { capi::wasmtime_concurrent_tls_get() }
}

#[cfg(feature = "component-model-async")]
#[inline]
pub fn concurrent_tls_set(ptr: *mut u8) {
    unsafe { capi::wasmtime_concurrent_tls_set(ptr) }
}
