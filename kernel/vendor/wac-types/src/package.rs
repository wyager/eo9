...
impl core::hash::Hash for dyn BorrowedKey + '_ {
...
impl<'a> TypeConverter<'a> {
    ...
    fn component_instance_type(
        ...
        let id = self.types.add_interface(Interface {
            ...
            uses: Default::default(),
            exports: IndexMap::with_capacity_and_hasher(instance_ty.exports.len(), Default::default()),
        });
    ...
    fn component_type(&mut self, name: Option<&str>, id: wasm::ComponentTypeId) -> Result<WorldId> {
        ...
        let id = self.types.add_world(World {
            id: name.and_then(|n| n.contains(':').then(|| n.to_owned())),
            uses: Default::default(),
            imports: IndexMap::with_capacity_and_hasher(component_ty.imports.len(), Default::default()),
            exports: IndexMap::with_capacity_and_hasher(component_ty.exports.len(), Default::default()),
        });
