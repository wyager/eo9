...
export function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  function _lowerImportBackwardsCompat(args) {
    ...
    const module0 = getCoreModule('outcomes.core.wasm');
    const module1 = getCoreModule('outcomes.core2.wasm');
    const module2 = getCoreModule('outcomes.core3.wasm');
    ...
    let gen = (function* _initGenerator () {
      ...
      const _trampoline2 = function(arg0, arg1, arg2, arg3, arg4) {
        var handle1 = arg0;
    ...
    _trampoline2.fnName = 'eo9:text/text@0.1.0#write';
    let exports2;
    let postReturn0;
    ...
    function main(arg0, arg1) {
      ...
      try {
        ret =   _withGlobalCurrentTaskMeta({
          taskID: task.id(),
          componentIdx: task.componentIdx(),
          fn: () => exports1Main(ptr0, len0, ptr1, len1),
        });
      } catch (err) {
