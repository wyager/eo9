...
unsafe extern "C" {
    ...
    /// Same contract as `wasmtime_tls_get`, but a separate single-pointer TLS
    /// slot used by Wasmtime's component-model-async ("concurrent") machinery.
    ///
    /// This value should default to `NULL`.
    #[cfg(feature = "component-model-async")]
    pub fn wasmtime_concurrent_tls_get() -> *mut u8;

    /// Sets the value returned by `wasmtime_concurrent_tls_get`.
    #[cfg(feature = "component-model-async")]
    pub fn wasmtime_concurrent_tls_set(ptr: *mut u8);
