//! `gfx.none` — absence of the pixel-output capability.
//!
//! Targets the `eo9:gfx/none` stub world: exports `eo9:gfx/gfx-optional` with
...
use exports::eo9::gfx::gfx_optional;
use exports::eo9::gfx::types;

/// The `gfx.none` provider.
struct Stub;
...
impl types::GuestGfxImpl for NoImpl {}

impl gfx_optional::Guest for Stub {
    fn default() -> Option<types::GfxImpl> {
        None
    }
}
