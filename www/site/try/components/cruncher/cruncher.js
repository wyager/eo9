...
export function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  const module0 = getCoreModule('cruncher.core.wasm');
  ...
  let gen = (function* _initGenerator () {
    ...
    function main(arg0, arg1) {
      ...
      try {
        ret =   _withGlobalCurrentTaskMeta({
          ...
          fn: () => exports0Main(toUint64(arg0), toUint64(arg1)),
        });
      } catch (err) {
        ...
        case 0: {
          ...
          switch (dataView(memory0).getUint8(ret + 8, true)) {
            case 0: {
              variant0= {
                tag: 'digest',
                val: BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(ret + 16, true)))
              };
              break;
            }
            default: {
    ...
    postReturn0 = exports0.cabi_post_main;
    
    try {
      postReturn0Async = WebAssembly.promising(exports0.cabi_post_main);
    } catch(err) {
      postReturn0Async = exports0.cabi_post_main;
    }
