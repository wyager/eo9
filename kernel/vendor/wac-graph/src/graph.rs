...
use core::ops::Index;
use alloc::{vec::Vec, string::String, string::ToString, format, borrow::ToOwned};
use thiserror::Error;
use wac_types::{
...
impl CompositionGraph {
    ...
    pub fn set_instantiation_argument(
        ...
        let mut cache = core::mem::take(&mut self.type_check_cache);
...
impl<'a> CompositionGraphEncoder<'a> {
    ...
    fn encode(self, options: EncodeOptions) -> Result<Vec<u8>, EncodeError> {
        ...
        let mut builder = core::mem::take(state.builder());
